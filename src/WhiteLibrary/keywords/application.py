...
class ApplicationKeywords(LibraryComponent):
    ...
    def _attach_application(self, sut_identifier, timeout=0):
        if timeout == 0:
        ...
        Wait.until_true(search_application,
                        ...
                        "Unable to locate application via identifier: {}".format(sut_identifier))
    ...
    @keyword
    def attach_application_by_id(self, sut_id, timeout=3):
